...
""",
    ...
    if "batch_prediction_result" in st.session_state:
        result_df = st.session_state["batch_prediction_result"].copy()
        # Ensure result dataframe is always available for charts, tables and exports.
        if result_df is None:
            st.error("No batch prediction result available.")
            st.stop()
